//
//  GeneralSelectRegionViewController.swift
//  MOF
//
...
import UIKit
class GeneralSelectRegionViewController : UIViewController, UIGestureRecognizerDelegate {
    ...
    func setFontnBackground(sender : UIButton){
        ...
        sender.titleLabel?.font = UIFont(name: "NotoSansCJKkr-Bold", size: 20)
        ...
        for i in tagList{
            ...
            print(tmpButton)
            tmpButton?.titleLabel?.font = UIFont(name: "NotoSansCJKkr-Bold", size: 20)
...
extension GeneralSelectRegionViewController : UITableViewDataSource,GeneralRegionCellDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "GeneralRegionTableViewCell") as! GeneralRegionTableViewCell
