...
class MyPagePageViewController: UIPageViewController {
    ...
    var completeHandler : ((Int)->())?
        ...
        let viewList : [UIViewController] = {
            ...
            let vc0 = storyBoard.instantiateViewController(identifier: "MyRegularClassViewontroller")
            let vc1 = storyBoard.instantiateViewController(identifier: "MyOnedayViewController")
    ...
    extension MyPagePageViewController: UIPageViewControllerDelegate, UIPageViewControllerDataSource {
