//
//  VoguingSearchViewController.swift
//  MOF
//
...
import UIKit
class VoguingSearchViewController : UIViewController{
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(self.refresh), name: NSNotification.Name(rawValue: "9"), object: nil)
    ...
    @objc func refresh() {
        ...
        dataManager.getSpecificAcademy(address: DetailSearchViewController.filterRegion, genre: Constant.GenreList[8], name: DetailSearchViewController.searchWord, delegate: self)
...
//MARK: - EXTENSION
extension VoguingSearchViewController : UITableViewDelegate,UITableViewDataSource{
...
extension VoguingSearchViewController : specificAcademyProtocol{
